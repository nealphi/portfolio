...
const About = () => (
  <Stack mb={"5"} fontSize={["sm", "md", "md", "lmd"]} color={"#a7a9ac"} textAlign={{ base:"justify", md:"left" }}>
    <Text>
      ...
      developer the following year.
      <br/>
      Having studied both Engineering and Applied Arts, I spent years exploring
      both fields until I settled where Engineering meets Art and Design.
      Minimal on the surface yet maximal in functionality, are the designs I
      most enjoy working on.
   <br/>
      When I'm not at the computer, you can find me in my studio behind my
      sewing machine, designing bags and apparel. Photography has been a lifelong hobby of mine.
    </Text>
  </Stack>
);
