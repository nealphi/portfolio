...
const MainContainer = () => {
  ...
  useEffect(() => {
    ...
    if (isSelectedBtn === "About") {
      window.scrollTo(0, 0);
    } else if (isSelectedBtn === "Resume") window.scrollTo(530, 530);
  ...
  return (
    ...
    >
      ...
      <GridItem display={"flex"} flexDirection={"column"} gap={10} p={5}>
        <About />

        <Resume
          tags={["React.js", "TypeScript", "JavaSript", "Tailwind css", "Chakra UI", "Material UI", "Emotion", "Vite"]}
...
<Resume
          ...
          children={"Analyzing business and operational processes, preparing process charts, and designing equipment and plant layouts. Creating work breakdown structures, breaking the operational processes into activities, and performing time studies for different work cycles."}
        />
      </GridItem>
    </Grid>     
  );
